...
* The original package name 'de.simplyroba.pixoo-bridge' is invalid and this project uses 'de.simplyroba.pixoobridge' instead.
...
```
$ docker run --rm pixoo-bridge:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/pixoo-bridge
```
